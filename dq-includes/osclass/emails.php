<?php if ( ! defined('ABS_PATH')) exit('ABS_PATH is not loaded. Direct access is not allowed.');
    ...
    function fn_email_auto_upgrade($result) {
        ...
        if($result['error']==0 || $result['error']==6) {
            ...
            if($result['error']==6) {
                $body .= __('<p>There were some minor errors removing temporary files. Please manually remove the "dq-content/downloads/oc-temp" folder</p>');
            }
        } else {
...
/* file end: ./dq-includes/osclass/emails.php */
?>