<?php
    ...
    */
    ...
    /**
     * Gets the root url of dq-admin for your installation
     *
     * @param boolean $with_index true if index.php in the url is needed
     * @return string
     */
    function osc_admin_base_url($with_index = false) {
        $path  = osc_base_url(false) . 'dq-admin/';
    ...
    */
    ...
    /**
    * Gets the root path of dq-admin
    *
    * @return string
    */
    function osc_admin_base_path() {
        return(osc_base_path() . "dq-admin/");
    }
    ...
    */
    ...
    /**
    * Gets the current dq-admin theme
    *
    * @return string
    */
    ...
    function osc_assets_url($file = '') {
        ...
        return osc_base_url() . 'dq-includes/osclass/assets/' . $file;
    }
    ...
    /* file end: ./dq-includes/osclass/helpers/hDefines.php */
?>