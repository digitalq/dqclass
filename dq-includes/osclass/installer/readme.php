...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en-US">
    <head>
            ...
            <link rel="stylesheet" type="text/css" media="all" href="<?php echo osc_getAbsoluteWebURL(); ?>/dq-includes/osclass/installer/install.css" />
    </head>
    <body>
        <div id="wrapper">
            <div id="container">
                <div id="header" class="readme">
                    <h1 id="logo">
                        <a href="http://osclass.org/" target="_blank">
                            <img src="<?php echo osc_getAbsoluteWebURL(); ?>/dq-includes/images/osclass-logo.png" alt="Osclass" title="Osclass" />
                        </a>
                        <br/>
			Version 3.3.0
                    </h1>
                    ...
                    <div id="install">
                        ...
                        <div class="space-left-10">
                            ...
                            <ol>
                                ...
                                <li>Execute the Osclass installation script by accessing <code>dq-includes/osclass/install.php</code> from your browser:
                                    <ul>
                                        <li>If you’ve installed it in the domain’s root directory, you’ll have to go to: <code>http://example.com/dq-includes/osclass/install.php</code></li>
                                        <li>If you’ve installed it in a subdirectory inside the domain, <em>classifieds</em>, for example, go to: <code>http://example.com/classifieds/dq-includes/osclass/install.php</code></li>
                                    </ul>
                                </li>
                                <li>Follow the installer’s instructions:
                                    <ul>
                                        ...
                                        <li>Your installation is finished! Use the automatically generated password to access your admin panel (/dq-admin).</li>
                                    </ul>
                                </li>
                            </ol>
                        </div>
                     ...
                     <div id="upgrade">
                        ...
                        <div class="space-left-10"><h3 style="border-bottom: 1px solid grey;color: #444444;">Manual upgrade</h3>
                            <p>
                                ...
                                Then run manually dq-includes/osclass/upgrade-funcs.php for do upgrade complete.
                            </p>
                        </div>
                        <p>If you experienced any problem during the process, please don't hesitate in contact us in <a href="http://forums.osclass.org/">Osclass Support Forums</a>.
                            ...
                            If you want to run the autoupgrade manually you could do that from the following URL : http://www.yourdomain.com/path/to/osclass/dq-admin/tools.php?action=upgrade
                        </p>
                    </div>
                    <div id="resources">
