...
function get_absolute_url( ) {
    ...
    $pos      = strpos($_SERVER['REQUEST_URI'], 'dq-includes');
...
function get_relative_url( ) {
    ...
    return substr($url, 0, strpos($url, '/dq-includes')) . "/";
}
...
function get_requirements( ) {
    $array = array(
        ...
        'Folder <code>dq-content/uploads</code> exists' => array(
            'requirement' => __('Folder <code>dq-content/uploads</code> exists'),
            'fn' => file_exists( ABS_PATH . 'dq-content/uploads/' ),
            'solution' => sprintf(__('You have to create <code>uploads</code> folder, i.e.: <code>mkdir %sdq-content/uploads/</code>' ), ABS_PATH)),

        'Folder <code>dq-content/uploads</code> is writable' => array(
            'requirement' => __('<code>dq-content/uploads</code> folder is writable'),
            'fn' => is_writable( ABS_PATH . 'dq-content/uploads/' ),
            'solution' => sprintf(__('<code>uploads</code> folder has to be writable, i.e.: <code>chmod a+w %sdq-content/uploads/</code>'), ABS_PATH)),
        // dq-content/downlods
        'Folder <code>dq-content/downloads</code> exists' => array(
            'requirement' => __('Folder <code>dq-content/downloads</code> exists'),
            'fn' => file_exists( ABS_PATH . 'dq-content/downloads/' ),
            'solution' => sprintf(__('You have to create <code>downloads</code> folder, i.e.: <code>mkdir %sdq-content/downloads/</code>' ), ABS_PATH)),

        'Folder <code>dq-content/downloads</code> is writable' => array(
            'requirement' => __('<code>dq-content/downloads</code> folder is writable'),
            'fn' => is_writable( ABS_PATH . 'dq-content/downloads/' ),
            'solution' => sprintf(__('<code>downloads</code> folder has to be writable, i.e.: <code>chmod a+w %sdq-content/downloads/</code>'), ABS_PATH)),
        // dq-content/languages
        'Folder <code>dq-content/languages</code> exists' => array(
            'requirement' => __('Folder <code>dq-content/languages</code> folder exists'),
            'fn' => file_exists( ABS_PATH . 'dq-content/languages/' ),
            'solution' => sprintf(__('You have to create the <code>languages</code> folder, i.e.: <code>mkdir %sdq-content/languages/</code>'), ABS_PATH)),

        'Folder <code>dq-content/languages</code> is writable' => array(
            'requirement' => __('<code>dq-content/languages</code> folder is writable'),
            'fn' => is_writable( ABS_PATH . 'dq-content/languages/' ),
            'solution' => sprintf(__('<code>languages</code> folder has to be writable, i.e.: <code>chmod a+w %sdq-content/languages/</code>'), ABS_PATH)),
    );
...
function oc_install( ) {
    ...
    $sql = file_get_contents( ABS_PATH . 'dq-includes/osclass/installer/struct.sql' );
    ...
    $required_files = array(
            ABS_PATH . 'dq-includes/osclass/installer/basic_data.sql',
            ABS_PATH . 'dq-includes/osclass/installer/pages.sql',
            ABS_PATH . 'dq-content/languages/' . osc_current_admin_locale() . '/mail.sql',
        );
        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text" id="dbname" name="dbname" value="dqclass" size="25" /></td>
                ...
                <tr>
                    ...
                    <td><input type="text" id="tableprefix" name="tableprefix" value="dq_" size="25" /></td>
...
<form id="target_form" name="target_form" action="#" method="post" onsubmit="return false;">
    ...
    <div class="form-table">
        ...
        <div class="admin-user">
            ...
            <img src="<?php echo get_absolute_url() ?>dq-includes/images/question.png" class="question-skip vtip" title="<?php echo osc_esc_html(__('You can modify username and password if you like, just change the input value.')); ?>" alt="" />
        </div>
        ...
        <div id="location-question" class="left question">
            <img class="vtip" src="<?php echo get_absolute_url(); ?>dq-includes/images/question.png" title="<?php echo osc_esc_html(__("Once you type a country, you'll be able to choose region and city as well. Therefore, the installation will be more specific.")); ?>" alt="" />
        </div>
        <div class="clear"></div>
        <div id="location">
...
<div id="lightbox" style="display:none;">
    <div class="center">
        <img src="<?php echo get_absolute_url(); ?>dq-includes/images/loading.gif" alt="<?php echo osc_esc_html(__("Loading...")); ?>" title="" />
    </div>
</div>
<?php
}
...
<a href="<?php echo get_absolute_url(); ?>dq-includes/osclass/install.php?step=<?php echo $step; ?>" class="button"><?php _e('Go back'); ?></a>
...
<p class="space-left-10"><?php echo sprintf(__('An e-mail with the password for dq-admin has been sent to: %s'), $data['s_email']);?></p>
<div style="clear:both;"></div>
...
<p class="margin20">
    <a target="_blank" href="<?php echo get_absolute_url() ?>dq-admin/index.php" class="button"><?php _e('Finish and go to the administration panel');?></a>
</p>
<?php
}
?>
