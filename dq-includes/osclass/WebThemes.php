<?php if ( ! defined('ABS_PATH')) exit('ABS_PATH is not loaded. Direct access is not allowed.');
    ...
    class WebThemes extends Themes
    {
        ...
        public function setCurrentThemeUrl()
        {
            if ( $this->theme_exists ) {
                ...
                $this->theme_url = osc_base_url() . 'dq-includes/osclass/gui/';
            }
        }
        ...
        /**
         * This function returns an array of themes (those copied in the dq-content/themes folder)
         * @return <type>
         */
    ...
    /* file end: ./dq-includes/osclass/WebThemes.php */