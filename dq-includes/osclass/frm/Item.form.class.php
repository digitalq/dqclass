                ...
                <ul class="qq-upload-list">
                    ...
                    <?php foreach($aImages as $img){ ?>
                        <li class=" qq-upload-success">
                            ...
                            <div class="ajax_preview_img"><img src="<?php echo osc_base_url(); ?>dq-content/uploads/temp/<?php echo osc_esc_html($img); ?>" alt="<?php echo osc_esc_html($img); ?>"></div>
                ...
                $(document).ready(function() {
                    ...
                    $('#restricted-fine-uploader').fineUploader({
                        ...
                        if (responseJSON.success) {
                            ...
                            <?php } ?>
                            $(li).append('<div class="ajax_preview_img"><img src="<?php echo osc_base_url(); ?>dq-content/uploads/temp/'+responseJSON.uploadName+'" alt="' + responseJSON.uploadName + '"></div>');
