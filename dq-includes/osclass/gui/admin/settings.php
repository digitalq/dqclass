...
<form name="_xclick" action="https://www.paypal.com/in/cgi-bin/webscr" method="post" class="nocsrf">
    ...
    <input type="hidden" name="custom" value="<?php echo osc_admin_render_theme_url('dq-content/themes/bender/admin/settings.php'); ?>&donation=successful&source=bender">
...
<form action="<?php echo osc_admin_render_theme_url('dq-content/themes/bender/admin/settings.php'); ?>" method="post" class="nocsrf">
