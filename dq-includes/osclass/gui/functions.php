...
<script type="text/javascript">
    ...
    function theme_bender_actions_admin() {
        //if(OC_ADMIN)
        if( Params::getParam('file') == 'dq-content/themes/bender/admin/settings.php' ) {
        ...
        switch( Params::getParam('action_specific') ) {
            case('settings'):
                ...
                osc_redirect_to(osc_admin_render_theme_url('dq-content/themes/bender/admin/settings.php'));
            break;
            case('upload_logo'):
                ...
                osc_redirect_to(osc_admin_render_theme_url('dq-content/themes/bender/admin/header.php'));
            break;
            case('remove'):
                $logo = osc_get_preference('logo','bender_theme');
    ...
    osc_admin_menu_appearance(__('Header logo', 'bender'), osc_admin_render_theme_url('dq-content/themes/bender/admin/header.php'), 'header_bender');
    osc_admin_menu_appearance(__('Theme settings', 'bender'), osc_admin_render_theme_url('dq-content/themes/bender/admin/settings.php'), 'settings_bender');
/**
