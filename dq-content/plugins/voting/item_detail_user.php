...
$path = osc_base_url().'/dq-content/plugins/'.  osc_plugin_folder(__FILE__); ?>
<div id="wrapper_voting_plugin">
    ...
    <style>
        ...
        #wrapper_voting_plugin .votes_star {
            background: url("<?php echo osc_base_url().'/dq-content/plugins/'.  osc_plugin_folder(__FILE__);?>img/ico_vot_vo.gif") repeat scroll 0 0 transparent;
            display: inline;
            float: left;
            height: 20px;
            margin: 0 4px 0 3px;
        ...
        #wrapper_voting_plugin .votes_star a:hover {
            background: url("<?php echo osc_base_url().'/dq-content/plugins/'.  osc_plugin_folder(__FILE__);?>img/ico_vot_ov.gif") repeat-x scroll 0 0 transparent;
        }
