    ...
    class Paypal
    {
        ...
        */
        ...
        public static function dgButton($amount = '0.00', $description = '', $itemnumber = '101', $extra_array = null) {
            ...
            . '&RETURNURL=' . osc_base_url() . 'dq-content/plugins/' . osc_plugin_folder(__FILE__) . 'return.php?extra=' . $extra //set your Return URL here
            . '&CANCELURL=' . osc_base_url() . 'dq-content/plugins/' . osc_plugin_folder(__FILE__) . 'cancel.php?extra=' . $extra //set your Cancel URL here
        ...
        public static function standardButton($amount = '0.00', $description = '', $itemnumber = '101', $extra_array = null) {
            ...
            $RETURNURL = osc_base_url() . 'dq-content/plugins/' . osc_plugin_folder(__FILE__) . 'return.php?extra=' . $extra;
            $CANCELURL = osc_base_url() . 'dq-content/plugins/' . osc_plugin_folder(__FILE__) . 'cancel.php?extra=' . $extra;
            $NOTIFYURL = osc_base_url() . 'dq-content/plugins/' . osc_plugin_folder(__FILE__) . 'notify_url.php?extra=' . $extra;
