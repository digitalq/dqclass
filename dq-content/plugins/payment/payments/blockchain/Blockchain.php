    ...
    class Blockchain
    {
        ...
        */
        public static function button($amount = '0.00', $description = '', $itemnumber = '101', $extra_array = null) {
            ...
            $r = rand(0,1000);
            $extra .= 'random,'.$r;
            $CALLBACK_URL = osc_base_url() . 'dq-content/plugins/' . osc_plugin_folder(__FILE__) . 'callback.php?extra=' . $extra;
        ?>
            ...
            data-callback="<?php echo $CALLBACK_URL; ?>">
                <div class="blockchain stage-begin">
                    <img src="<?php echo osc_base_url() . 'dq-content/plugins/' . osc_plugin_folder(__FILE__); ?>pay_now_64.png">
                </div>
                <div class="blockchain stage-loading" style="text-align:center">
                    <img src="<?php echo osc_base_url() . 'dq-content/plugins/' . osc_plugin_folder(__FILE__); ?>loading-large.gif">
                </div>
