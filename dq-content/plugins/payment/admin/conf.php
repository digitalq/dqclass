    ...
    <div class="form-horizontal">
        <div class="form-row">
            ...
            <p>
                ...
                <br/>
                <?php _e("Click Choose IPN Settings to specify your listener’s URL and activate the listener (usually is http://www.yourdomain.com/dq-content/plugins/payment/notify_url.php)", 'payment'); ?>.
            </p>
