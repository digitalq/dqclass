<?php
    $js_lang = array(
        'delete' => __('Delete', 'digitalq'),
        'cancel' => __('Cancel', 'digitalq')
    );
...
<script type="text/javascript">
    var digitalq = window.digitalq || {};
    digitalq.base_url = '<?php echo osc_base_url(true); ?>';
    digitalq.langs = <?php echo json_encode($js_lang); ?>
    digitalq.fancybox_prev = '<?php echo osc_esc_js( __('Previous image','digitalq')) ?>';
    digitalq.fancybox_next = '<?php echo osc_esc_js( __('Next image','digitalq')) ?>';
    digitalq.fancybox_closeBtn = '<?php echo osc_esc_js( __('Close','digitalq')) ?>';
</script>
