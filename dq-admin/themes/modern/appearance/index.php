        ...
        <div id="tabs" class="ui-osc-tabs ui-tabs-right">
            ...
            <div id="available-themes" class="ui-osc-tabs-panel">
                ...
                <div class="current-theme">
                    <div class="theme">
                        <img src="<?php echo osc_base_url(); ?>/dq-content/themes/<?php echo osc_theme(); ?>/screenshot.png" title="<?php echo $info['name']; ?>" alt="<?php echo $info['name']; ?>" />
                ...
                <div class="available-theme">
                    ...
                    <div class="theme">
                        <div class="theme-stage">
                            <img src="<?php echo osc_base_url(); ?>/dq-content/themes/<?php echo $theme; ?>/screenshot.png" title="<?php echo $info['name']; ?>" alt="<?php echo $info['name']; ?>" />
